...
it('returns provider instance when valid provider is given', function() {
...
it('throws exception when invalid provider is given', function() {
    $providerManager = Mockery::mock(ProviderManager::class);
...
it('configures provider model correctly', function() {
    ...
    expect($settings->implement)->toBe([\Igniter\System\Actions\SettingsModel::class])
